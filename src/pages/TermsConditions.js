...
const TermsConditions = () => {
  return (
    <Wrapper>
      <Content>
        <Headrer1>
          EUREKA TERMS AND CONDITIONS. <br />{" "}
          <span>Last updated May 8, 2022</span>
        </Headrer1>
        {/* AGREEMENT TO TERMS */}
        <Headrer2>AGREEMENT TO TERMS</Headrer2>
        <Details>
          These Terms of Use constitute a legally binding agreement made between
          you, whether personally or on behalf of an entity (“you”) and [EUREKA]
          (“we,” “us” or “our”), concerning your access to and use of the Eureka
          application and website as well as any other media form, media
          channel, mobile website or mobile application related, linked, or
          otherwise connected thereto (collectively, the “Site”). <br /> <br />
          ...
          jurisdiction or country. <br /> <br />
          Accordingly, those persons who choose to access the Site from other
          locations do so on their own initiative and are solely responsible for
          compliance with local laws, if and to the extent local laws are
          applicable. <br /> <br />
          Option 1: The Site is intended for users who are at least 13 years
          old. Persons under the age of 13 are not permitted to use or register
          for the Site. <br /> <br />
          ...
          to these Terms of Use prior to you using the Site. <br /> <br />
        </Details>
        {/* INTELLECTUAL PROPERTY RIGHTS */}
        <Headrer2>INTELLECTUAL PROPERTY RIGHTS</Headrer2>
        <Details>
        ...
        <Headrer2>USER REPRESENTATIONS</Headrer2>
        <Details>
          ...
          update such registration information as necessary; <br /> <br />
          ...
          whether through a bot, script or otherwise; <br /> <br />
          ...
          any portion thereof). <br /> <br />
        </Details>
        {/* USER REGISTRATION */}

        <Headrer2>USER REGISTRATION</Headrer2>
        <Details>
          ...
          You may request for a removal or deletion of your account and its data, with a reason
          communicated through any medium listed under “CONTACT US”.

        </Details>
        {/* PRODUCTS */}
        <Headrer2>PRODUCTS</Headrer2>
        <Details>
        ...
        <Headrer2>PURCHASES AND PAYMENT</Headrer2>
        <Details>
          We accept the following forms of payment: Algerie Poste to a specified
          account and/or by cash in hand transaction with a trusted third party.
          ...
          by us. We may change prices at any time. All payments shall be in the
          currency displayed on the product. <br /> <br />
          ...
          requiring your prior approval for each recurring charge, until such
          time as you cancel the applicable order.] We reserve the right to
        ...
        <Headrer2>RETURN/REFUNDS POLICY</Headrer2>
        <Details>
          All sales are final and no refund will be issued, the user is allowed
          to make a complaint which will be subject to review and subsequent
          action based on our discretion. Please review our Return Policy posted
          on the Site prior to making any purchases. <br /> <br />
        </Details>
        {/* PROHIBITED ACTIVITIES */}
        <Headrer2>PROHIBITED ACTIVITIES</Headrer2>
        <Details>
          ...
          accounts by automated means or under false pretenses. <br /> <br />
          ...
          Site and/or the Content contained therein. <br /> <br />
          ...
          collection mechanisms” or “pcms”). <br /> <br />
          ...
          or launching any unauthorized script or other software. <br /> <br />
        ...
        <Headrer2>USER GENERATED CONTRIBUTIONS</Headrer2>
        <Details>
          ...
          contemplated by the Site and these Terms of Use. <br /> <br />
          ...
          personal from anyone under the age of 18 or exploits people under the
          age of 18 in a sexual or violent manner. <br /> <br />
          ...
          suspension of your rights to use the Site. <br /> <br />
        </Details>
        {/* CONTRIBUTION LICENSE */}
        <Headrer2>CONTRIBUTION LICENSE</Headrer2>
        <Details>
          ...
          in your Contributions provided by you in any area on the Site. <br />{" "}
          <br />
        ...
        <Details>
          ...
          racist, offensive, or hate language; <br /> <br />
          ...
          orientation, or disability; <br /> <br />
        ...
        <Headrer2> MOBILE APPLICATION LICENSE</Headrer2>
        <Details>
          <Headrer2>Use License</Headrer2>
          ...
          send any unsolicited commercial e-mail; <br /> <br />
          ...
          devices for use with the application. <br /> <br />
          <Headrer2> Apple and Android Devices</Headrer2>
          ...
          Distributor’s terms of service; <br /> <br />
          ...
          service agreement when using the mobile application; <br /> <br />
          ...
          third-party beneficiary thereof. <br /> <br />
        </Details>
        {/* SOCIAL MEDIA */}
        <Headrer2> SOCIAL MEDIA</Headrer2>
        <Details>
          ...
          provider of the Third-Party Account. <br /> <br />
          ...
          Content may no longer be available on and through the Site. <br />{" "}
          <br />
          ...
          AGREEMENT(S) WITH SUCH THIRD-PARTY SERVICE PROVIDERS. <br /> <br />
          ...
          also registered to use the Site. <br /> <br />
          ...
          profile picture that become associated with your account. <br />{" "}
          <br />
        </Details>
        {/* SUBMISSIONS */}
        <Headrer2>SUBMISSIONS</Headrer2>
        <Details>
          ...
          misappropriation of any proprietary right in your Submissions. <br />{" "}
          <br />
        </Details>
        {/* THIRD-PARTY WEBSITES AND CONTENT */}
        <Headrer2>THIRD-PARTY WEBSITES AND CONTENT</Headrer2>
        <Details>
          ...
          Websites or the Third-Party Content. <br />
          <br />
          ...
          aware these Terms of Use no longer govern. <br />
          <br />
          ...
          exclusively between you and the applicable third party. <br />
          <br />
        ...
        <Details>
          ...
          rights, and contractual rights. <br />
          <br />
          ...
          no other relationship with advertisers. <br />
          <br />
        </Details>
        {/* SITE MANAGEMENT */}
        <Headrer2>SITE MANAGEMENT</Headrer2>
        <Details>
          ...
          limitation, reporting such user to law enforcement authorities; <br />
          <br />
        ...
        {/* PRIVACY POLICY */}
        <Headrer2>PRIVACY POLICY</Headrer2>
        <Details>
          ...
          Site as quickly as is reasonably practical.] <br />
          <br />

          We collect Personal and Sensitve User Data like your login (email address and password)
          details, full name, address, postal code, phone number, proof of payment for purchases (image),
          image (camera and/or gallery) data and are securely stored on our server, these data WOULD
          NEVER be shared with a third party or manipulated for any reason but only serve its purpose as
          required by the Site. For more enquiry on your Personal and Sensitve User Data collection, you
          can contact us.
        ...
        <Details>
          <Headrer2>Notifications </Headrer2>
          ...
          “Notification”). <br />
          <br />A copy of your Notification will be sent to the person who
          ...
          512(c)(3) and include the following information: <br />
          <br />
          ...
          infringed upon. <br />
          <br />
          <Headrer2>Counter Notification </Headrer2>
          ...
          be liable for damages, including costs and attorney&#39;s fees. Filing
          a false Counter Notification constitutes perjury. <br />
          <br />
        ...
        <Headrer2>COPYRIGHT INFRINGEMENTS</Headrer2>
        <Details>
          We respect the intellectual property rights of others. If you believe
          that any material available on or through the Site infringes upon any
          ...
          material addressed in the Notification. <br />
          <br />
        ...
        <Headrer2>TERM AND TERMINATION</Headrer2>
        <Details>
          ...
          you may be acting on behalf of the third party. <br />
          <br />
        ...
        <Headrer2>MODIFICATIONS AND INTERRUPTIONS</Headrer2>
        <Details>
          We reserve the right to change, modify, or remove the contents of the
          Site at any timeor for any reason at our sole discretion without
          notice. However, we have no obligation to update any information on
          our Site. We also reserve the right to modify or discontinue all or
          part of the Site without notice at any time. <br />
          <br />
          ...
          reason without notice to you. <br />
          <br />
          You agree that we have no liability whatsoever for any loss, damage,
          or inconvenience caused by your inability to access or use the Site
        ...
        {/* GOVERNING LAW */}
        <Headrer2>GOVERNING LAW</Headrer2>
        <Details>
          ...
          of law principles. <br />
          <br />
        </Details>
        {/* DISPUTE RESOLUTION */}
        <Headrer2>DISPUTE RESOLUTION</Headrer2>
        <Details>
          ...
          such state and federal courts. <br />
          <br />
          ...
          related in any way to the Site be commenced more than 2 years after
          the cause of action arose. <br />
          <br />
          <Headrer2>Option 2: Informal Negotiations</Headrer2>
          ...
          for at least 90 days before initiating arbitration. Such informal
          negotiations commence upon written notice from one Party to the other
          Party. <br />
          <br />
          <Headrer2>Binding Arbitration</Headrer2>
          ...
          <a href="www.adr.org.">www.adr.org.</a> <br />
          <br />
          ...
          on the award entered by the arbitrator. <br />
          <br />
          ...
          lack of personal jurisdiction, and forum non convenient with respect
          ...
          Transaction Act (UCITA) are excluded from these Terms of Use. <br />
          <br />
          ...
          that court. <br />
          <br />
          <Headrer2>Option 3: Binding Arbitration</Headrer2>
          To expedite resolution and control the cost of any dispute,
          controversy or claim related to these Terms of Use (each a
          &quot;Dispute&quot; and collectively, “Disputes”), any Dispute brought
          ...
          at the AAA website <a href="www.adr.org.">www.adr.org.</a> <br />
          <br />
          Your arbitration fees and your share of arbitrator compensation shall
          be governed by the AAA Consumer Rules and, where appropriate, limited
          by the AAA Consumer Rules. [If such costs are determined to by the
          ...
          state], and the Parties hereby consent to, and waive all defenses of
          lack of, personal jurisdiction, and forum non convenient with respect
          to venue and jurisdiction in such state and federal courts. <br />
          <br />
          Application of the United Nations Convention on Contracts for the
          International Sale of Goods and the Uniform Computer Information
          Transaction Act (UCITA) are excluded from these Terms of Use. <br />{" "}
          ...
          above, and the Parties agree to submit to the personal jurisdiction of
          that court. <br /> <br />
          <Headrer2>Option 2/Option 3: Restrictions</Headrer2>
          ...
          claim for injunctive relief. <br /> <br />
        ...
        <Headrer2>LIMITATIONS OF LIABILITY</Headrer2>
        <Details>
          ...
          TO YOU, AND YOU MAY HAVE ADDITIONAL RIGHTS.] <br />
          <br />
        </Details>
        {/* INDEMNIFICATION */}
        <Headrer2>INDEMNIFICATION</Headrer2>
        <Details>
        ...
        <Details>
          ...
          OF TRANSACTIONS INITIATED OR COMPLETED BY US OR VIA THE SITE. <br />
          <br />
        ...
        <Headrer2>CALIFORNIA USERS AND RESIDENTS</Headrer2>
        <Details>
          If any complaint with us is not satisfactorily resolved, you can
          contact the Complaint Assistance Unit of the Division of Consumer
          Services of the California Department of Consumer Affairs in writing
          at 1625 North Market Blvd., Suite N 112, Sacramento, California 95834
          or by telephone at (800) 952-5210 or (916) 445-1254. <br />
          <br />
        </Details>

        {/* MISCELLANEOUS */}
        <Headrer2>MISCELLANEOUS</Headrer2>
        <Details>
          ...
          Terms of Use or use of the Site. <br />
          <br />
          ...
          you may have based on the electronic form of these Terms of Use and
        ...
        {/* CONTACT US */}
        <Headrer2>CONTACT US</Headrer2>
        <Details>
          In order to resolve a complaint regarding the Site or to receive
          further information <br />
          regarding use of the Site, please contact us at: <br />
          Eureka <br />
          Residence Universite Bab Ezzouar 03, Algiers, Algeria. <br />
          +213 549332546<br />
          <a href="mailto: contact.eurekapp@gmail.com">
            contact.eurekapp@gmail.com
          </a>{" "}
          <br />
        </Details>
      </Content>
